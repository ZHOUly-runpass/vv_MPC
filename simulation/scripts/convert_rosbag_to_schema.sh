...
PYTHONPATH="$project_dir/src" "$project_dir/.tools/envs/planner/bin/python" scripts/extract_rosbag_training_frames.py --bag "$bag" \
...
PYTHONPATH="$project_dir/src" "$project_dir/.tools/envs/planner/bin/python" scripts/assemble_training_samples.py \
